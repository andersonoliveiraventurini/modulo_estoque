                                    ...
                                    @foreach ($formasIniciais as $idx => $formaOld)
                                        ...
                                        <div class="forma-card rounded-xl border-2 p-4 transition-all
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4 items-end">
                                                ...
                                                @php
                                                    $condicaoId = $formaOld['condicao_id'] ?? '';
                                                    $condicaoObj = $condicoesBalcao->firstWhere('id', $condicaoId);
                                                    $isCartaoCredito = $condicaoObj && $condicaoObj->tipo === 'cartao_credito';
                                                    $showParcelas = $isCartaoCredito || (!empty($formaOld['parcelas']) && $formaOld['parcelas'] > 1);
                                                @endphp
                                                <div class="div-parcelas {{ !$showParcelas ? 'hidden' : '' }}">
            ...
            <script>
                ...
                function onCondicaoChange(selectEl) {
                    ...
                    if (selectEl.selectedIndex >= 0) {
                        ...
                        if (parcelavel || tipo === 'cartao_credito') {
