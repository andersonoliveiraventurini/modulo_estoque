                ...
                <form action="{{ route('produtos.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-2">
                            ...
                            <x-input type="number" name="qtd_vendida_pacotes" label="Qtd Vendida (Pacotes)" />
                            <x-input name="familia_tipo" label="Tipo/Família" placeholder="Ex: Nylon, Aderente..." />
                            <x-select name="categoria_id" label="Categoria">
                                <option value="">Selecione...</option>
                            </x-select>
                            <x-checkbox name="flag_encomenda" label="Produto sob encomenda" />
                        </div>
                        <!-- Endereço -->
                        <div class="space-y-4"><br />
                            ...
                            <div class="space-y-4"><br />
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-2">
                                    ...
                                    <x-input name="ncm" label="NCM - Nomenclatura Comum do Mercosul (8 dígitos)"
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="flex gap-4">
                                        <x-button type="submit" class="bg-primary-600 text-white">Cadastrar
                                            Produto</x-button>
