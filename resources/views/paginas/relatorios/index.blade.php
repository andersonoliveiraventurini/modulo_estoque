<x-layouts.app :title="'Relatórios de Estoque'">
    <div class="flex h-full w-full flex-1 flex-col gap-6 rounded-xl p-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {{-- Estoque Crítico --}}
            <a href="{{ route('relatorios.estoque_critico') }}" class="group block p-6 rounded-xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 shadow-sm hover:border-red-500 transition-all hover:shadow-md">
                <div class="flex items-center gap-4 mb-4">
                    <div class="p-3 rounded-lg bg-red-100 dark:bg-red-900/30 text-red-600">
            ...
            {{-- Data de Vencimento --}}
            <a href="{{ route('relatorios.vencimento_produtos') }}" class="group block p-6 rounded-xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 shadow-sm hover:border-indigo-500 transition-all hover:shadow-md">
                <div class="flex items-center gap-4 mb-4">
            ...
            <a href="{{ route('relatorios.reposicao_estoque') }}" class="group block p-6 rounded-xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 shadow-sm hover:border-indigo-500 transition-all hover:shadow-md">
                <div class="flex items-center gap-4 mb-4">
                    <div class="p-3 rounded-lg bg-indigo-100 dark:bg-indigo-900/30 text-indigo-600">
            ...
            <a href="{{ route('relatorios.recebimento_produtos') }}" class="group block p-6 rounded-xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 shadow-sm hover:border-indigo-500 transition-all hover:shadow-md">
                <div class="flex items-center gap-4 mb-4">
                    <div class="p-3 rounded-lg bg-indigo-100 dark:bg-indigo-900/30 text-indigo-600">
            ...
            {{-- Devoluções --}}
            <a href="{{ route('relatorios.devolucoes') }}" class="group block p-6 rounded-xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 shadow-sm hover:border-orange-500 transition-all hover:shadow-md">
                <div class="flex items-center gap-4 mb-4">
                    <div class="p-3 rounded-lg bg-orange-100 dark:bg-orange-900/30 text-orange-600">
            ...
            {{-- Não Conformidade --}}
            <a href="{{ route('relatorios.nao_conformidade') }}" class="group block p-6 rounded-xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 shadow-sm hover:border-yellow-500 transition-all hover:shadow-md">
                <div class="flex items-center gap-4 mb-4">
                    <div class="p-3 rounded-lg bg-yellow-100 dark:bg-yellow-900/30 text-yellow-600">
            ...
            {{-- Saída de Produtos --}}
            <a href="{{ route('relatorios.saida_produtos') }}" class="group block p-6 rounded-xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 shadow-sm hover:border-indigo-500 transition-all hover:shadow-md">
                <div class="flex items-center gap-4 mb-4">
                    <div class="p-3 rounded-lg bg-indigo-100 dark:bg-indigo-900/30 text-indigo-600">
            ...
            {{-- Vendas e Margem --}}
            <a href="{{ route('relatorios.vendas_margem') }}" class="group block p-6 rounded-xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 shadow-sm hover:border-emerald-500 transition-all hover:shadow-md">
                <div class="flex items-center gap-4 mb-4">
                    <div class="p-3 rounded-lg bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600">
