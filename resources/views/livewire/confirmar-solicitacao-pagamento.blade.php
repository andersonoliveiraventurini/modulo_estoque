                        ...
                        <div class="flex gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-sm text-red-800 dark:text-red-300 mt-1">
                                    Este cliente possui restrições ativas. Lembre-se que o pagamento padrão para clientes bloqueados é restrito a PIX, Dinheiro ou Cartão. Verifique atentamente esta solicitação especial.
                                </p>
                                ...
                                <div class="flex items-start gap-2">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="text-lg font-bold text-gray-900 dark:text-gray-100">
                                            R$
                                            {{ number_format($orcamento->valor_com_desconto > 0 ? $orcamento->valor_com_desconto : $orcamento->valor_total_itens ?? 0, 2, ',', '.') }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="space-y-3">
                            ...
                            <div class="ring-1 ring-black ring-opacity-5 dark:ring-white dark:ring-opacity-10 rounded-lg overflow-hidden"
                                ...
                                <div
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <!-- Badge do Status -->
                                        <span
                                            class="px-3 py-1 text-xs font-semibold rounded-full bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-300">
                                            {{ $solicitacao->status }}
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="bg-white dark:bg-zinc-900 p-4">
                                    ...
                                    <div class="mb-4">
                                        <div
                                            ...
                                            <div class="flex items-start gap-3">
                                                ...
                                                <div class="flex-1">
                                                    <p
                                                        class="text-xs font-medium text-blue-600 dark:text-blue-400 mb-2">
                                                        Descrição do Meio de Pagamento:</p>
                                    ...
                                    @if ($solicitacao->numero_parcelas || $solicitacao->valor_entrada || $solicitacao->data_primeiro_vencimento)
                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                            @if ($solicitacao->numero_parcelas)
                                                <div
                                                    class="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg">
                                                    <div
                                                        class="flex items-center justify-center w-10 h-10 bg-gray-100 dark:bg-gray-700 rounded-full">
                                                        <x-heroicon-o-calculator
                                                            class="w-5 h-5 text-gray-600 dark:text-gray-400" />
                                                    </div>
                                                    <div class="flex-1">
                                                        <p class="text-xs text-gray-600 dark:text-gray-400 font-medium">
                                                            Número de Parcelas</p>
                                                        <p class="text-lg font-bold text-gray-900 dark:text-gray-100">
                                                ...
                                                <div
                                                    ...
                                                    <div class="flex-1">
                                                        ...
                                                        <p class="text-lg font-bold text-green-700 dark:text-green-300">
                                                            R$
                                                            {{ number_format($solicitacao->valor_entrada, 2, ',', '.') }}
                                                        </p>
                                                    </div>
                                                </div>
                                            @endif
                                            ...
                                            @if ($solicitacao->data_primeiro_vencimento)
                                                <div
                                                    ...
                                                    <div
                                                        class="flex items-center justify-center w-10 h-10 bg-purple-100 dark:bg-purple-900/40 rounded-full">
                                    ...
                                    @if ($solicitacao->justificativa_solicitacao)
                                        <div
                                            ...
                                            <p class="text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">
                                                Justificativa da Solicitação:</p>
                                            <p class="text-sm text-gray-900 dark:text-gray-100">
                                    ...
                                    <div
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <input type="text" wire:model="justificativas.{{ $solicitacao->id }}"
                                            ...
                                            @error('justificativa_' . $solicitacao->id)
                        ...
                        @empty
                            <div
                                ...
                                <p class="text-sm">Todas as solicitações foram avaliadas ou não há solicitações
                                    pendentes.</p>
                            </div>
                        @endforelse
                    </div>
    ...
    <script>
        document.addEventListener('livewire:init', () => {
            Livewire.on('alert', (event) => {
                ...
                Swal.fire({
                    title: type === 'success' ? 'Sucesso!' : type === 'error' ? 'Erro!' :
                        'Atenção!',
                    text: message,
                    icon: type,
