                                ...
                                <tr class="hover:bg-indigo-50/30 dark:hover:bg-indigo-900/10 transition duration-150">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex justify-end space-x-1">
                                            ...
                                            @else
                                                <button wire:click="marcarComoImpresso({{ $ordem->id }})" class="px-3 py-1.5 text-gray-400 dark:text-zinc-500 hover:text-gray-600 dark:hover:text-zinc-300 font-semibold underline underline-offset-4 decoration-dotted">
                                                    PDF
                                                </button>
                                            @endif
                                        </div>
