<div>
    ...
    <button wire:click="$toggle('showModal')" class="btn btn-primary">
        <i class="fas fa-cash-register"></i> Processar Pagamento
    </button>

    <!-- Modal -->
    <div class="modal fade @if($showModal) show d-block @endif" tabindex="-1" style="@if($showModal) background-color: rgba(0,0,0,0.5); @endif">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <p><strong>Condição Original:</strong> {{ $orcamento->condicaoPagamento->nome ?? 'N/A' }}</p>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3 align-items-end" wire:key="forma-{{ $index }}">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <input type="number" 
                                           wire:model.live="formasPagamento.{{ $index }}.valor" 
                                           class="form-control" 
                                           step="0.01" 
                                           min="0"
                                           placeholder="0,00">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" 
                                           wire:model.live="descontoBalcao" 
                                           class="form-control" 
                                           step="0.01" 
                                           min="0"
                                           max="{{ $valorTotal * 0.03 }}"
                                           placeholder="0,00">
                                    <small class="text-muted">Máximo: R$ {{ number_format($valorTotal * 0.03, 2, ',', '.') }}</small>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Percentual</label>
                                    <input type="text" 
                                           class="form-control" 
                                           value="{{ $valorTotal > 0 ? number_format(($descontoBalcao / $valorTotal) * 100, 2, ',', '.') : 0 }}%" 
                                           readonly>
                                </div>
                            </div>
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="form-check mb-3">
                                <input type="checkbox" 
                                       wire:model.live="precisaNotaFiscal" 
                            ...
                            <div class="form-check mb-3">
                                <input type="checkbox" 
                                       wire:model.live="notaOutroCnpjCpf" 
                                       class="form-check-input" 
                        ...
                        <div class="card-body">
                            <table class="table table-borderless mb-0">
                                ...
                                <tr>
                                    ...
                                    <td class="text-end text-danger">- R$ {{ number_format($descontoAplicado, 2, ',', '.') }}</td>
                                </tr>
                                @endif
                                @if($descontoBalcao > 0)
                                <tr>
                                    <td><strong>Desconto no Balcão:</strong></td>
                                    <td class="text-end text-danger">- R$ {{ number_format($descontoBalcao, 2, ',', '.') }}</td>
                                </tr>
                                @endif
                                <tr class="border-top">
                                    <td><strong>Valor a Pagar:</strong></td>
                                    <td class="text-end"><h5 class="mb-0">R$ {{ number_format($valorComDesconto, 2, ',', '.') }}</h5></td>
                                </tr>
                                <tr class="border-top">
                                    <td><strong>Valor Pago:</strong></td>
                                    <td class="text-end"><h5 class="mb-0 text-primary">R$ {{ number_format($valorPago, 2, ',', '.') }}</h5></td>
                                </tr>
                                @if($troco > 0)
                                <tr>
                                    <td><strong>Troco:</strong></td>
                                    <td class="text-end"><h5 class="mb-0 text-success">R$ {{ number_format($troco, 2, ',', '.') }}</h5></td>
                                </tr>
                                @endif
                            </table>
