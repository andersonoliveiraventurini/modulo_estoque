    ...
    <div class="bg-white dark:bg-zinc-900 rounded-2xl border border-neutral-200 dark:border-neutral-700 p-4 shadow">
        ...
        <div class="flex flex-wrap items-end gap-3">
            <div>
                ...
                <input type="text" wire:model.live.debounce.500ms="f_cliente"
            ...
            <div>
                ...
                <input type="text" wire:model.live.debounce.500ms="f_sku"
                    class="rounded-md border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
            ...
            <div>
                ...
                <select wire:model.live="f_status_item"
                    class="rounded-md border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100">
            ...
            <div>
                ...
                <select wire:model.live="f_status_lote"
                    class="rounded-md border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100">
            ...
            <div>
                ...
                <select wire:model.live="f_armazem_id"
                    class="rounded-md border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100">
                    <option value="">Todos</option>
            ...
            <div class="flex-1 min-w-[220px]">
                ...
                <input type="text" wire:model.live.debounce.500ms="f_busca"
